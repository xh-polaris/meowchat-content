...
type (
	...
	CreateImageElement = pb.CreateImageElement
	CreateImageReq     = pb.CreateImageReq
	CreateImageResp    = pb.CreateImageResp
	DeleteCatReq       = pb.DeleteCatReq
	DeleteCatResp      = pb.DeleteCatResp
	DeleteImageReq     = pb.DeleteImageReq
	DeleteImageResp    = pb.DeleteImageResp
	Image              = pb.Image
	ListCatReq         = pb.ListCatReq
	ListCatResp        = pb.ListCatResp
	ListImageReq       = pb.ListImageReq
	ListImageResp      = pb.ListImageResp
...
func (m *defaultCollectionRpc) ListImage(ctx context.Context, in *ListImageReq, opts ...grpc.CallOption) (*ListImageResp, error) {
	client := pb.NewCollectionRpcClient(m.cli.Conn())
